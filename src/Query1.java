...
/**
 * Find URLs of Wikipedia articles that contain all of the stemmed keywords
infantri, reinforc, brigad, and fire.
 */
public class Query1 {
    ...
    public static class QueryOneReducer extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context)
            ...
            if(Launcher.containsTerm(terms, Launcher.infantri) &&
           Launcher. containsTerm(terms, Launcher.reinforc) &&
